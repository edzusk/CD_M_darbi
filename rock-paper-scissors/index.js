...
(function () { return __awaiter(_this, void 0, void 0, function () {
    var score, keepPlaying, PC_SELECTION, response, PLAYER_SELECTION, playAgain;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                _a.label = 1;
            case 1:
                if (!keepPlaying) return [3 /*break*/, 4];
            ...
            case 2:
                response = _a.sent();
                PLAYER_SELECTION = ELEMENTS[response.elementIndex];
                if (PLAYER_SELECTION.title === PC_SELECTION.title) {
                    console.log('The game is draw!');
                }
                else if (PLAYER_SELECTION.beats.includes(PC_SELECTION)) {
                    console.log("\n ".concat(PLAYER_SELECTION.title, " beats ").concat(PC_SELECTION.title, " \n Player wins"));
                    score["Player"]++;
                }
                else {
                    console.log("\n ".concat(PC_SELECTION.title, " beats ").concat(PLAYER_SELECTION.title, " \n PC wins"));
                    score['PC']++;
                }
