...
console.log(isEven(4)); //expected true
console.log(isEven(1.123)); //expected false
console.log(isEven(1048)); //expected true
console.log(isEven(10.48)); //expected false
...
const isContaining = (str1:string, str2:string):string => 
    str1.includes(str2) ? str2.concat(str1): str1 + str2;
...
const tidyUp = (str1:string, str2:string): string => 
    str1.replace('%', '').slice(0, 1).toUpperCase() + str1.replace('%', '').slice(1,str1.length) + str2.split('').reverse().join('').replace('%', '');
...
const nextAlphabet = (str:string) =>{
    return str.split('').map(el => el.charCodeAt(0)+1).map(el =>String.fromCharCode(el)).join('')
}
...
const joinArr = (...args:any[]):any[] => {
    return args.reduce(function (arr1:any[], arr2:any[]) {
...
const unshiftGreaterSix = (arr: any[], num:number):any[] => {
    ...
    // return arr;
    let newArr = num < 6 ? [0].concat(arr) : [num].concat(arr);
    return newArr;
}
...
const isInObj= (obj: {[key:string]: string | number}, str:string) => obj[str] ? true : false;
...
console.log(sumOfKeyValues({j:9,i:2,x:3,z:4})); //Expected 18
...
console.log(objWithoutB({ e: 6, f: 4, b: 5, a: 3 })); //Expected { e: 6, f: 4, a: 3 }
...
console.log(multiplyObjectValuesBy({j:9,i:2,x:3,z:4},10)); //Expected {j:90,i:20,x:30,z:40}
...
console.log(swapObjkeys({z:'a',y:'b',x:'c',w:'d'})); //Expected {a:'z',b:'y',c:'x',d:'w'}
console.log(swapObjkeys({2:'a',4:'b',6:'c',8:'d'})); //Expected {a:'2',b:'4',c:'6',d:'8'}
...
console.log(fillValueas({ a: '', b: 'b', c: ' ', d: 'd' })); //Expected { a: null, b: 'b', c: null, d: 'd' }
console.log(fillValueas({ a: 'a', b: 'b ', c: ' ', d: '' })); //Expected { a: 'a', b: 'b ', c: null, d: null }
...
console.log(personalInfo({fn: 'Lisa', ln: 'Müller', age: 17, size: 175, weight: 67})); //Expected {fn: 'Lisa', ln: 'Müller', size: '175cm', weight: '67kg'}
console.log(personalInfo({fn: 'Martin', ln: 'Harper', age: 26, email: 'martin.harper@test.de', weight: 102})); //Expected {fn: 'Martin', ln: 'Harper', weight: '102kg'}
console.log(personalInfo({fn: 'Andrew', ln: 'Harper', age: 81, size: 175, weight: 71})); //Expected {fn: 'Andrew', ln: 'Harper', size: '175cm', weight: '71kg'}
console.log(personalInfo({fn: 'Matthew', ln: 'Müller', age: 19, email: 'matthew@mueller.de'})); //Expected {fn: 'Matthew', ln: 'Müller'}
...
const combineTwoObjs = (obj1:{[key:string|number]:string|number}, obj2:{[key:string|number]:string|number}) => {
    return {...obj1, ...obj2}
}

console.log(combineTwoObjs({ a:1, b:2 }, { c:3, d:4 })); //Expected { a:1, b:2, c:3, d:4 }
console.log(combineTwoObjs({ a:1, b:2 }, { c:3, d:4, e:5, f:6 })); //Expected { a:1, b:2, c:3, d:4, e:5, f:6 }
...
const objWithStr = (obj1:{[key:string|number]:string|number}, str:string)=> {
    return {...obj1, 'favoriteMovie': str}
}
