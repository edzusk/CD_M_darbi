...
import { addAnimal, Animal, filter, getAnimals, Habitat } from '../../store/animalslice'
  ...
  return (
    <div className="container">
      ...
      <div className={style.addAnimalWrapper}>
        ...
        className={style.addAnimalForm} action="">

          <input
          onChange={(e) => setanimalname(e.target.value)}
          required={true}
          type="text" placeholder='Elephant...' />
          <input
          onChange={(e) => setimageUrl(e.target.value)}
          required={true}
          type="text" placeholder='https://.....' />

          <select value={habitat}
